                                ...
                                foreach ($penghuni as $penghuni) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?= time() > strtotime($penghuni->tgl_keluar) ? '<span class="badge badge-danger">Rp. ' . number_format(ceil(date_diff(date_create(date('Y-m-d', time())), date_create($penghuni->tgl_keluar))->format('%a') / 30) * $penghuni->harga, 0, ',', '.') . '</span>' : '<span class="badge badge-success">Sudah Lunas</span>'; ?>
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-sm btn-success active edit-huni" href="<?= base_url('list-tagihan#kamar=' . $penghuni->no_kamar) ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tambah Pembayaran">
